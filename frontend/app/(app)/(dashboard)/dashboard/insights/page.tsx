...
// ML-evaluation view (confusion matrix, raw feature importance, tier
// calibration). Kept here at /dashboard/insights but intentionally NOT linked
// from the sidebar — the business-facing Analytics page (/dashboard/analytics)
// is the surfaced one. Reachable directly by URL for model diagnostics.
function Page() {
  ...
  return (
    <div className="space-y-6 mx-auto pb-8">
      <header className="space-y-1">
        <h1 className="text-2xl font-bold text-foreground">Model diagnostics</h1>
