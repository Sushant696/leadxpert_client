...
function HeroSection() {
  ...
  return (
    <section className="relative flex items-center py-12 sm:py-16 px-2 sm:px-4 lg:px-6 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-primary/20 via-indigo-50/30 to-purple-50/20" />
      <motion.div
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          <motion.div
            ...
            className="space-y-6 lg:space-y-10 lg:col-span-5"
          >
            <motion.div
            ...
            <div className="space-y-6">
              ...
              >
                Built for service-based businesses in Nepal. Manage leads, track
                deals, and close more sales with our intuitive CRM platform.
              </motion.p>
            </div>
          ...
          <div
            className="hidden lg:block lg:col-span-7 relative h-[500px]"
